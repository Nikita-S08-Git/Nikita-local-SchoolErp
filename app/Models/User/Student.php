...
class Student extends Model
{
    ...
    protected $fillable = [
        ...
        // 'caste' removed because category already captures similar info
    ...
    /**
     * Get the admission record associated with the student.
     */
    ...
    /**
     * Get all academic records for the student (session-wise).
     *
     * DATABASE: student_academic_records.student_id -> students.id
     * USAGE: $student->academicRecords (get all session-wise records)
     */
    public function academicRecords(): HasMany
    {
        return $this->hasMany(\App\Models\Academic\StudentAcademicRecord::class);
    }

    /**
     * Get the current/active academic record for the student.
     *
     * USAGE: $student->currentAcademicRecord (get current session record)
     */
    public function currentAcademicRecord(): HasOne
    {
        return $this->hasOne(\App\Models\Academic\StudentAcademicRecord::class)
            ->ofMany('created_at', 'max');
    }

    /**
     * Get promotion logs for the student.
     *
     * DATABASE: promotion_logs.student_id -> students.id
     * USAGE: $student->promotionLogs (get all promotion history)
     */
    public function promotionLogs(): HasMany
    {
        return $this->hasMany(\App\Models\Academic\PromotionLog::class);
    }

    /**
     * Get transfer record for the student.
     *
     * DATABASE: transfer_records.student_id -> students.id
     * USAGE: $student->transferRecord (get transfer/TC details)
     */
    public function transferRecord(): HasOne
    {
        return $this->hasOne(\App\Models\Academic\TransferRecord::class);
    }
...
public function scholarships()
{
    ...
    ->withPivot(['discount_amount', 'academic_year', 'is_active'])
    ->withTimestamps();
}
