@php
    $principalMenuItems = [
        ...
        ['name' => 'Results', 'route' => 'principal.results', 'icon' => 'bar-chart'],
...
<div class="sidebar d-none d-md-flex flex-column text-white p-3">
    <div class="mb-4">
        ...
        <p class="small mb-0 text-white opacity-75">Principal Portal</p>
    </div>

    <hr class="my-3 border-white opacity-50">

    @foreach($principalMenuItems as $item)
