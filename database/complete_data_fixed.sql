-- ============================================
-- COMPLETE SCHOOL ERP DATA - FIXED VERSION
...
(1, 'Commerce', 'COM', 'Department of Commerce and Business Studies', 1, NOW(), NOW()),
(2, 'Science', 'SCI', 'Department of Science', 1, NOW(), NOW()),
(3, 'Arts', 'ART', 'Department of Arts and Humanities', 1, NOW(), NOW()),
(4, 'Management', 'MGT', 'Department of Management Studies', 1, NOW(), NOW())
...
-- ============================================
-- 7. INSERT USERS (All passwords: password)
-- ============================================
DELETE FROM users WHERE email IN (
    'principal@schoolerp.com',
    'teacher@schoolerp.com',
    'class.teacher@schoolerp.com',
    'hod.commerce@schoolerp.com',
    'hod.science@schoolerp.com',
    'math.teacher@schoolerp.com',
    'english.teacher@schoolerp.com',
    'physics.teacher@schoolerp.com',
    'chemistry.teacher@schoolerp.com',
    'biology.teacher@schoolerp.com'
);
...
(1, 'EMP001', '+91 9876543201', 'M.Com, Ph.D', 20, 'Accounting & Finance', 'Principal', 1, NOW(), NOW()),
(2, 'EMP002', '+91 9876543202', 'M.Com, B.Ed', 10, 'Business Management', 'Senior Lecturer', 1, NOW(), NOW()),
...
(2, 2, 2, 'division', 0, NOW(), NOW()),
(3, 1, 1, 'division', 1, NOW(), NOW()),
(3, 1, 1, 'subject', 1, NOW(), NOW()),
(4, 1, 1, 'department', 1, NOW(), NOW()),
(4, 1, 2, 'subject', 1, NOW(), NOW()),
(5, 4, 9, 'department', 1, NOW(), NOW()),
(5, 4, 10, 'subject', 1, NOW(), NOW()),
...
('Annual Sports Day', 'Annual sports event', '2026-03-15', '2026-03-15', 'program', 0, 1, 2, 'Main Ground', 1, NOW(), NOW()),
('Annual Day Function', 'Cultural program', '2026-04-20', '2026-04-20', 'program', 0, 1, 3, 'Auditorium', 1, NOW(), NOW()),
('Science Exhibition', 'Science exhibition', '2026-05-10', '2026-05-12', 'event', 0, 1, 5, 'Science Block', 1, NOW(), NOW()),
...
('Eid-ul-Fitr', 'End of Ramadan', '2026-04-10', '2026-04-10', 'school_holiday', 0, 1, NULL, NULL, 1, NOW(), NOW()),
...
('Navratri Break', 'Nine nights festival', '2026-10-15', '2026-10-18', 'school_holiday', 0, 1, NULL, NULL, 1, NOW(), NOW());

-- ============================================
-- 12. INSERT TIMETABLES (50 records)
-- ============================================
...
-- VERIFICATION
-- ============================================
SELECT '✅ COMPLETE DATA INSERTION DONE!' AS status;
SELECT 'Departments:' AS info, COUNT(*) AS count FROM departments;
SELECT 'Programs:' AS info, COUNT(*) AS count FROM programs;
SELECT 'Divisions:' AS info, COUNT(*) AS count FROM divisions;
SELECT 'Subjects:' AS info, COUNT(*) AS count FROM subjects;
SELECT 'Users:' AS info, COUNT(*) AS count FROM users WHERE email LIKE '%@schoolerp.com';
SELECT 'Holidays:' AS info, COUNT(*) AS count FROM holidays;
SELECT 'Timetables:' AS info, COUNT(*) AS count FROM timetables;

SELECT '=== LOGIN CREDENTIALS ===' AS '';
SELECT 'Email: principal@schoolerp.com | Password: password | Role: Principal' AS credentials;
SELECT 'Email: teacher@schoolerp.com | Password: password | Role: Teacher' AS credentials;
SELECT 'Email: class.teacher@schoolerp.com | Password: password | Role: Class Teacher' AS credentials;
SELECT 'Email: hod.commerce@schoolerp.com | Password: password | Role: HOD Commerce' AS credentials;
SELECT 'Email: hod.science@schoolerp.com | Password: password | Role: HOD Science' AS credentials;
