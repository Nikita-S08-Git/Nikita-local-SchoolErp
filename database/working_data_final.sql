-- ============================================
-- SCHOOL ERP DATA - WORKING VERSION
...
-- 3. ACADEMIC YEARS (Using YOUR table structure)
INSERT INTO academic_years (id, program_id, year_number, year_name, semester_start, semester_end, is_active, created_at, updated_at) VALUES
(1, 1, 1, '2024-25', 1, 2, 1, NOW(), NOW()),
(2, 1, 2, '2025-26', 1, 2, 1, NOW(), NOW());
